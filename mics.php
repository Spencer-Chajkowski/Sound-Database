...
$db = 'spechajkowskiProject`'; //selecting my database
...
$connect = mysqli_connect("localhost","spechajkowski","6w7eDr4KVwdLySbB","spechajkowskiProject");
	echo "<h4>Microphones</h4>";
$query = "SELECT * FROM  `campus_sound` INNER JOIN mics ON campus_sound.`asset_number` = mics.`asset_number` ORDER BY campus_sound.`asset_number;";
