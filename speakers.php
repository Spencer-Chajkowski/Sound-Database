...
$query = "SELECT * FROM `campus_sound` INNER JOIN speakers ON campus_sound.`asset_number` = speakers.`asset_number` ORDER BY campus_sound.`asset_number;";
	echo $query."<br>";
$print = mysqli_query($connect,$query) 
						or die("Error! Data not found!");
echo "<table border=1>";

	echo "<tr><th>Catagory</th><th>Model</th><th>Brand</th><th>Asset Number</th><th>Deployed To</th><th>Purchace Date</th></tr>";
